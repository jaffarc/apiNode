...
module.exports = () => {
     ...
     *       }
    **/
    const loginController = require('./get')();
     ...
     *       }
    **/
    const findGetUserController = require('./get')();
    router.get('/find/user', findGetUserController);
     ...
     *       }
    **/
    const findPostUserController = require('./post')();
     ...
     *       }
    **/
    const removeUserController = require('./put')();
 ...
 *       }
**/
    const registerUserController = require('./post/register')();
