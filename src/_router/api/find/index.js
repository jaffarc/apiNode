...
module.exports = () => {
     ...
     *       }
    **/
    const findGetUserController = require('../find/user/get')();
    router.get('/user/:id', findGetUserController);
     ...
     *       }
    **/
    const findPostUserController = require('../find/user/post')();
    router.post('/user', findPostUserController);
    return router;
};
